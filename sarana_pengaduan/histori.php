...
<div class="history-container">
    ...
    <h2>Histori Perubahan Status</h2>

    <a href="list_aspirasi.php" class="btn-back">⬅ Kembali ke Daftar</a>
    ...
    <table class="history-table">
        ...
        <tr>
            ...
            <td>
                <?php if($h['feedback']){ echo $h['feedback']; } else { echo '-'; } ?>
            </td>
            <td>
